...
void LCD_Initializtion(void)
{
	...
	if( DeviceCode == 0x9325 || DeviceCode == 0x9328 )	
	{
		...
		//LCD_WriteReg(0x03, 0xD030); /* set GRAM write direction and BGR=1 */
		...
		//LCD_WriteReg(0x13, 0x0F00); /* VDV[4:0] for VCOM amplitude */
		LCD_WriteReg(0x29, 0x0027); /* 04 VCM[5:0] for VCOMH */
		//LCD_WriteReg(0x29, 0x0005); /* 04 VCM[5:0] for VCOMH */
...
{	
	...
	sprintf((char* )lcd_buff1,"FPS:%d",str);
